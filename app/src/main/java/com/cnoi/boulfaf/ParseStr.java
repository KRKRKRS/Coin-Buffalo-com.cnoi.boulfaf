...
import static com.cnoi.boulfaf.F_B_K.AD_ID;
import static com.cnoi.boulfaf.C9B.AppsFl_Id;
import static com.cnoi.boulfaf.C9B.keyDefault;
...
public class ParseStr {
    ...
    String parse(String input) {
        ...
        result.append(params[0]).append("?")
                .append(decode("YnVuZGxlPQ==")).append("com.cnoi.boulfaf")
    ...
    String parseOrganic(String input) {
        return input + keyDefault +
                decode("P2J1bmRsZT0=") + "com.cnoi.boulfaf" +
